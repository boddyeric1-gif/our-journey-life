...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Our Journey — daily rituals for closer connection" },
      { name: "twitter:description", content: "Daily prompts, gentle quests, and the small rituals that make connection feel tended-to. For couples, for family, for yourself — meaningful whether you open it together or alone." },
