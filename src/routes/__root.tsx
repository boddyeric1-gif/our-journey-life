...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Our Journey — a private space for two" },
      { property: "og:description", content: "A quiet, beautifully made couples app. Daily prompts, gentle quests, and the small rituals that keep love tended-to." },
